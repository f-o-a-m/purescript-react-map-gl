...
mapClass =
  ...
  mapOnLoadHandler mapRef = do
    ...
    for_ (MapGL.getMap =<< iMap) \map -> do
      ...
      let
        (source :: HeatmapData) = Mapbox.mkGeoJsonSource $ GeoJson.mkFeatureCollection []
...
type HeatmapData
  = Mapbox.GeoJsonSource HeatmapDataFeatureCollection

type HeatmapDataFeatureCollection
  = GeoJson.FeatureCollection HeatmapDataFeature

type HeatmapDataFeature
  = GeoJson.Feature GeoJson.PointGeometry HeatmapDataProps
...
heatmapWeight =
  Mapbox.mkPaintProperty "heatmap-weight"
    $ Mapbox.SEArray
        [ -- interpolate expression -- https://docs.mapbox.com/mapbox-gl-js/style-spec/#expressions-interpolate
...
heatmapIntensity =
  Mapbox.mkPaintProperty "heatmap-intensity"
    $ Mapbox.SEArray
        [ Mapbox.SEString "interpolate"
        , Mapbox.SEArray [ Mapbox.SEString "linear" ]
...
heatmapColor =
  Mapbox.mkPaintProperty "heatmap-color"
    $ Mapbox.SEArray
        [ Mapbox.SEString "interpolate"
        , Mapbox.SEArray [ Mapbox.SEString "linear" ]
...
heatmapRadius =
  Mapbox.mkPaintProperty "heatmap-radius"
    $ Mapbox.SEArray
        [ Mapbox.SEString "interpolate"
...
heatmapOpacity =
  Mapbox.mkPaintProperty "heatmap-opacity"
    $ Mapbox.SEArray
        [ Mapbox.SEString "interpolate"
        , Mapbox.SEArray [ Mapbox.SEString "linear" ]
        , Mapbox.SEArray [ Mapbox.SEString "zoom" ]
